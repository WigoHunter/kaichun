...
export default function Home() {
  ...
  return (
    <main className="bg-white py-12 sm:py-16 overflow-hidden">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 overflow-hidden">
        <section className="intro-section">
          <div className="mx-auto max-w-4xl flex flex-col items-center overflow-hidden">
            <Image
              ...
              priority
            />
            <h1 className="mt-8 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl text-center">{t('title')}</h1>
        ...
        <section aria-labelledby="writing-section" className="mt-16">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 id="writing-section" className="mx-auto mt-12 w-xl font-bold tracking-tight text-gray-900 text-2xl">
        ...
        <section aria-labelledby="reading-section" className="mt-16">
          <div className="max-w-2xl mx-auto">
            <hr className="my-8 border-gray-200 mx-auto dark:border-gray-700" />
          </div>
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 id="reading-section" className="mx-auto mt-12 w-xl font-bold tracking-tight text-gray-900 text-2xl">
        ...
        <section aria-labelledby="project-section" className="mt-16">
          <div className="max-w-2xl mx-auto">
            <hr className="my-8 border-gray-200 mx-auto dark:border-gray-700" />
          </div>
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 id="project-section" className="mx-auto mt-12 w-xl font-bold tracking-tight text-gray-900 text-2xl">
        ...
        <section aria-labelledby="contact-section" className="mt-16">
          <div className="max-w-2xl mx-auto">
            <hr className="my-8 border-gray-200 mx-auto dark:border-gray-700" />
          </div>
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 id="contact-section" className="mx-auto mt-12 max-w-xl sm:w-xl font-bold tracking-tight text-gray-900 text-2xl">{t('contact')}</h2>
